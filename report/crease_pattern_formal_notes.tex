...
repeating ones, with sharper wedges weighted more heavily. This score is not a
correctness condition; it is only a tie-breaker among already admissible
assignments.
...
If exact face reconstruction fails, the project falls back to a triangle-mesh
preview. In that mode the domain is triangulated and propagated along a tree of
triangle adjacencies. This is still useful visually, but it is intentionally
marked as non-certifying.
